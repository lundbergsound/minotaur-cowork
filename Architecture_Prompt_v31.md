...
**Arch never commits.** Landing a file in a mount is not installing it: Daniel confirms, commits and pushes. `git push` is always Daniel's own paste.
