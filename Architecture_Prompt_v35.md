# Architecture Prompt v35

*(v35 · 2026-09-11 · retires v34 · the Roadmap rules replaced, two rules deleted to pay for it, **net −-852 characters** — Daniel, 2026-09-11: no additions without removals · why, in full: Ledger 2026-09-11 append · incident histories: `Architecture_Provenance.md`)*
...
*⚠ **Deleted in v35, named so neither is reinstated: the Docket Sweep line** (a fact carried only there dies with the version that carried it — SWEEPLINE-NOT-DURABLE) **and "read the Roadmap WHOLE"** (only safe to drop alongside the caps above).*

*Incident histories O-1…O-12: `Architecture_Provenance.md`, read on citation like the Ledger. End of Architecture Prompt v35 — retires v34.*
